...
export function ensureProjectFiles() {
  for (const dir of ['.agents', '.agents/skills', '.agents/skills/goods-radar', 'config', 'data', 'lib', 'modes', 'reports', 'reports/data-framework', 'reports/evaluations', 'reports/llm-evaluations', 'reports/weekly', 'samples']) {
  ...
  ensureTsv('data/contacts.tsv', CONTACT_HEADERS);
  ensureTsv('data/source-feedback.tsv', SOURCE_FEEDBACK_HEADERS);
  ensureTsv('data/quotes.tsv', QUOTE_HEADERS);
  ensureTsv('data/trials.tsv', TRIAL_HEADERS);
}
