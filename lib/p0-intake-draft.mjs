...
| ready 行 | ${model.counts.ready_rows} |
| 跳过行 | ${model.counts.skipped_rows} |
| 验证问题 | ${model.counts.validation_issues} |

## 2. 草稿输出

${mdTable(['草稿', '行数', '路径'], outputRows)}

## 3. 草稿行

${mdTable(['草稿 ID', '供应商', '对象'], draftRows)}
